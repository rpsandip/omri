...
create index IX_21D5AC7F on OMRI_Clinic (clinicName[$COLUMN_LENGTH:75$]);
...
create index IX_2ED143DE on OMRI_Patient (customPatientId[$COLUMN_LENGTH:75$]);
...
create index IX_7CA7B94B on OMRI_Resource (resourceName[$COLUMN_LENGTH:75$]);

create index IX_7BEBA7CF on OMRI_Resource_Specification (resourceId, specificationId);

create index IX_4EE2C5BF on OMRI_Specification (specificationName[$COLUMN_LENGTH:75$]);