				...
				if(clinicId!=appointmentClinicId){
					...
					if(Validator.isNull(newClinicPatient)){
						...
						newClinicPatient = Patient_ClinicLocalServiceUtil.addPatient_Clinic(patientId, appointmentClinicId,
								existingPatientClinic.getDoctorId(), existingPatientClinic.getDoctorName(), existingPatientClinic.getDoctorPhoneNo(), existingPatientClinic.getDoctorEmail(),existingPatientClinic.getLawyerId(), existingPatientClinic.getLawyerName(), existingPatientClinic.getLawyerPhoneNo(), existingPatientClinic.getLawyerEmail(),existingPatientClinic.getPatient_status(), 
